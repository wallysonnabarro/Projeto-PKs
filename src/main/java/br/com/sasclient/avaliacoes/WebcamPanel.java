...
public class WebcamPanel extends JPanel implements WebcamListener, PropertyChangeListener {
	...
	public void webcamOpen1(WebcamEvent we) {
	...
	public void webcamClosed1(WebcamEvent we) {
		stop();
	}

	public void webcamDisposed1(WebcamEvent we) {
		stop();
	}

	public void webcamImageObtained1(WebcamEvent we) {
		// do nothing
	}
